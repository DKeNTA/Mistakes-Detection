...
if __name__ == "__main__":
    ...
    SPECTROGRAMS_SAVE_DIR = "melspectrograms_22050_0.37/"
    MIN_MAX_VALUES_SAVE_DIR = "min_max_values/"
    FILES_DIR = "dataset_trimmed/"

    # instantiate all objects
    loader = Loader(SAMPLE_RATE, DURATION, MONO)
    padder = Padder()
    log_spectrogram_extractor = LogSpectrogramExtractor(SAMPLE_RATE, FRAME_SIZE, HOP_LENGTH, N_MELS)
